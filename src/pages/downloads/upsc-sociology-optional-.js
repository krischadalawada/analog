...
const Target = () => {
    return (
        <>
            <Head>
                <title>UPSC Sociology (Optional)</title>
            </Head>

            <Header />
            <HeroDownloads title="UPSC Sociology (Optional)" />
            <>
                    ...
                    <div className="container-sm">
                        <div className='col-xl-12 col-md-12 col-12 m-auto'>
                            <table className='downloads-table'>
                                ...
                                {DownloadsData.filter(x => x.title === 'UPSC Sociology (Optional)')[0].list.map((val, key) => {
                                    return (
                                        <tr key={key}>
                                            <td>{key + 1}</td>
                                            <td>{val.title}</td>
