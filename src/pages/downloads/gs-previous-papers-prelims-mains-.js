...
const Target = () => {
    return (
        <>
            <Head>
                <title>GS Previous papers (Prelims + Mains)</title>
            </Head>

            <Header />
            <HeroDownloads title="GS Previous papers (Prelims + Mains)" />
            <>
                    ...
                    <div className="container-sm">
                        <div className='col-xl-12 col-md-12 col-12 m-auto'>
                            <table className='downloads-table'>
                                ...
                                {DownloadsData.filter(x => x.title === 'GS Previous Papers')[0].list.map((val, key) => {
                                    return (
                                        <tr key={key}>
                                            <td>{key + 1}</td>
                                            <td>{val.title}</td>
