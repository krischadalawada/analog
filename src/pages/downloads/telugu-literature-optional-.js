...
const Target = () => {
    return (
        <>
            <Head>
                <title>Telugu Literature (Optional)</title>
            </Head>

            <Header />
            <HeroDownloads title="Telugu Literature (Optional)" />
            <>
                    ...
                    <div className="container-sm">
                        <div className='col-xl-12 col-md-12 col-12 m-auto'>
                            <table className='downloads-table'>
                                ...
                                {DownloadsData.filter(x => x.title === 'Telugu Literature (Optional)')[0].list.map((val, key) => {
                                    return (
                                        <tr key={key}>
                                            <td>{key + 1}</td>
                                            <td>{val.title}</td>
