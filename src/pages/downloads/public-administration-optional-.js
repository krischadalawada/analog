...
const Target = () => {
    return (
        <>
            <Head>
                <title>Public Administration (Optional)</title>
            </Head>

            <Header />
            <HeroDownloads title="Public Administration (Optional)" />
            <>
                    ...
                    <div className="container-sm">
                        <div className='col-xl-12 col-md-12 col-12 m-auto'>
                            <table className='downloads-table'>
                                ...
                                {DownloadsData.filter(x => x.title === 'Public Administration (Optional)')[0].list.map((val, key) => {
                                    return (
                                        <tr key={key}>
                                            <td>{key + 1}</td>
                                            <td>{val.title}</td>
