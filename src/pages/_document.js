    ...
    return (
        <Html>
            <Head>
                ...
                <script async src="https://www.googletagmanager.com/gtag/js?id=G-TXVM33B5LW"></script>
                 <script dangerouslySetInnerHTML={{
                    __html:`window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-TXVM33B5LW');`
                    }}>
                       </script>
