               ...
               <div className="row">
                  <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-6">
                     <div className="teacher__details-thumb p-relative mr-30">
                        <img className="team-thumb" src={singleTeam?.team_img} alt="" />
                     ...
                     <div className="teacher__wrapper">
                        <div className="teacher__top d-md-flex align-items-end justify-content-between">
                           <div className="teacher__info">
                              ...
                              <span>Teaches {singleTeam?.teaches}</span>
                           </div>
                              ...
                              <div className="row">

                                 {
                                    coursesItems.slice(0, 4).map(course => {
                                       const { img_bg, category, price, title, enrolled, watching, review,
                                          teacher_img, _id } = course;
