...
const FAQ = () => {
    ...
    return (
        <>
            <section className="research__area research__border pt-30 pb-30 p-relative z-index-1">
                <div className="container-lg">
                    <div className="row">
                        <div className="col-xxl-12">
                            <div className="section__title-wrapper mb-50 text-center">
                                <h2 className="section__title section__title-50">Frequently Asked Questions (FAQs)</h2>
                            </div>
                        </div>
                    </div>
