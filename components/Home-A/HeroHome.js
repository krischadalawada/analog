      ...
      <>
         <section className="bg-home" style={{ caretColor: 'transparent' }}>
            ...
            <div className="banner-slider " >
                     ...
                     <div>
                        <img style={{ width: '100%'}} src="assets/images/home/Slide_3.jpg" alt="Banner 3" />
            ...
            <div className="slider__content-2 mt-30 pb-30 container">
                        ...
                        <h3 className="slider__title-sub">New Batches for IAS 2024 <br />starting from 15th April 2023</h3>
